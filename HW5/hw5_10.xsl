...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/ReviewApplication">
        ...
        <table border="1">
            ...
            <xsl:variable name="resid" select="RestaurantId"></xsl:variable>
                <tr>
                    <td>
                        <xsl:value-of select="/ReviewApplication/Companys/Company/Restaurants/Restaurant[RestaurantId/text() = $resid/text()]/Name"/>
                    </td>
                    <td>
                        <xsl:value-of select="/ReviewApplication/Users/User[UserName/text() = $username/text()]/FirstName"/>
                    </td>
                    <td>
